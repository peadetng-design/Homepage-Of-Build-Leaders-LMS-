...
const Hero: React.FC<HeroProps> = ({ onRegister, onSignIn, currentUser, onNavigateToDashboard }) => {
  ...
  if (!content) return <div className="min-h-screen bg-white" />; // Loading state
                  ...
                  {[
                    ...
                    return (
                      ...
                      >
                         ...
                         <p className={`mb-8 leading-relaxed font-medium text-white/95`}>
                           {resource.desc}
                         </p>
