...
import { Search, BookOpen, ChevronRight, Play, Clock, Star, Layers, LayoutGrid, Info, Library, GraduationCap, ChevronDown, CheckCircle, ShieldCheck, Download, Trophy, Target, Share2, Save, FileText, File as FileIcon, Activity, Database, RefreshCcw } from 'lucide-react';
         ...
         <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b-[6px] border-indigo-50 pb-8 mb-10">
            <div>
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h2 className="text-4xl font-serif font-black text-gray-950 uppercase tracking-tighter leading-none">Curriculum Browser</h2>
                                ...
                                return courseModules.map((mod, modIdx) => {
                                    ...
                                    return modLessons.map((les, lesIdx) => (
                                        <tr key={les.id} className="group hover:bg-royal-50/10 transition-all align-top">
                                            {/* COLUMN 1: COURSE - OPTIMIZED HEIGHT (520PX) */}
                                            ...
                                            <td className="p-8 align-middle bg-gray-50/30 group-hover:bg-white transition-colors">
                                                <div className="h-[520px] overflow-y-auto custom-scrollbar pr-4 space-y-6 flex flex-col justify-center">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-3 pt-2">
                                                        <button 
                                                            className="p-4 bg-white text-gray-600 border-[3px] border-gray-100 rounded-2xl hover:border-indigo-400 hover:text-indigo-600 transition-all flex flex-col items-center justify-center gap-2 shadow-md"
                                ...
                                <tr>
                                    <td colSpan={6} className="p-32 text-center bg-gray-50/30">
                                        <div className="max-w-xl mx-auto space-y-8">
                                            ...
                                            <h3 className="text-3xl font-serif font-black text-gray-950 uppercase tracking-tighter">Registry Persistence Empty</h3>
